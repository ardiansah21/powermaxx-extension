...
- [2026-03-01] Strategi distribusi tim dikunci via GitHub Release dengan satu artifact resmi `build/chrome-mv3-prod.zip`; versioning disederhanakan ke `MAJOR.MINOR.PATCH` dengan tag `vX.Y.Z` untuk memudahkan rollback dan audit rilis.
